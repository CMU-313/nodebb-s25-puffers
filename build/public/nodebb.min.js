...
*/(function(r){w=[b(74692)],x=r,S=typeof x=="function"?x.apply(N,w):x,S!==void 0&&(Y.exports=S)})(function(r){r.timeago=function(i){return i instanceof Date?_(i):_(typeof i=="string"?r.timeago.parse(i):typeof i=="number"?new Date(i):r.timeago.datetime(i))};var A=r.timeago;r.extend(r.timeago,{settings:{refreshMillis:6e4,allowPast:!0,allowFuture:!1,localeTitle:!1,cutoff:0,autoDispose:!0,strings:{prefixAgo:null,prefixFromNow:null,suffixAgo:"ago",suffixFromNow:"from now",inPast:"any moment now",seconds:"less than a minute",minute:"about a minute",minutes:"%d minutes",hour:"about an hour",hours:"about %d hours",day:"a day",days:"%d days",month:"about a month",months:"%d months",year:"about a year",years:"%d years",wordSeparator:" ",numbers:[]}},inWords:function(i){if(!this.settings.allowPast&&!this.settings.allowFuture)throw"timeago allowPast and allowFuture settings can not both be set to false.";var h=this.settings.strings,f=h.prefixAgo,l=h.suffixAgo;if(this.settings.allowFuture&&i<0&&(f=h.prefixFromNow,l=h.suffixFromNow),!this.settings.allowPast&&i>=0)return this.settings.strings.inPast;var d=Math.abs(i)/1e3,v=d/60,j=v/60,D=j/24,F=D/365;function z(de,a){var ve=r.isFunction(de)?de(a,i):de,be=h.numbers&&h.numbers[a]||a;return ve.replace(/%d/i,be)}var ee=d<45&&z(h.seconds,Math.round(d))||d<90&&z(h.minute,1)||v<45&&z(h.minutes,Math.round(v))||v<90&&z(h.hour,1)||j<24&&z(h.hours,Math.round(j))||j<42&&z(h.day,1)||D<30&&z(h.days,Math.round(D))||D<45&&z(h.month,1)||D<365&&z(h.months,Math.round(D/30))||F<1.5&&z(h.year,1)||z(h.years,Math.round(F)),re=h.wordSeparator||"";return h.wordSeparator===void 0&&(re=" "),r.trim([f,ee,l].join(re))},parse:function(i){var h=r.trim(i);return h=h.replace(/\.\d+/,""),h=h.replace(/-/,"/").replace(/-/,"/"),h=h.replace(/T/," ").replace(/Z/," UTC"),h=h.replace(/([\+\-]\d\d)\:?(\d\d)/," $1$2"),h=h.replace(/([\+\-]\d\d)$/," $100"),new Date(h)},datetime:function(i){var h=A.isTime(i)?r(i).attr("datetime"):r(i).attr("title");return A.parse(h)},isTime:function(i){return r(i).get(0).tagName.toLowerCase()==="time"}});var p={init:function(){p.dispose.call(this);var i=r.proxy(m,this);i();var h=A.settings;h.refreshMillis>0&&(this._timeagoInterval=setInterval(i,h.refreshMillis))},update:function(i){var h=i instanceof Date?i:A.parse(i);r(this).data("timeago",{datetime:h}),A.settings.localeTitle&&r(this).attr("title",h.toLocaleString()),m.apply(this)},updateFromDOM:function(){r(this).data("timeago",{datetime:A.parse(A.isTime(this)?r(this).attr("datetime"):r(this).attr("title"))}),m.apply(this)},dispose:function(){this._timeagoInterval&&(window.clearInterval(this._timeagoInterval),this._timeagoInterval=null)}};r.fn.timeago=function(i,h){var f=i?p[i]:p.init;if(!f)throw new Error("Unknown function name '"+i+"' for timeago");return this.each(function(){f.call(this,h)}),this};function m(){var i=A.settings;if(i.autoDispose&&!r.contains(document.documentElement,this))return r(this).timeago("dispose"),this;var h=T(this);return isNaN(h.datetime)||(i.cutoff===0||Math.abs(s(h.datetime))<i.cutoff?r(this).text(_(h.datetime)):r(this).attr("title").length>0&&r(this).text(r(this).attr("title"))),this}function T(i){if(i=r(i),!i.data("timeago")){i.data("timeago",{datetime:A.datetime(i)});var h=r.trim(i.text());A.settings.localeTitle?i.attr("title",i.data("timeago").datetime.toLocaleString()):h.length>0&&!(A.isTime(i)&&i.attr("title"))&&i.attr("title",h)}return i.data("timeago")}function _(i){return A.inWords(s(i))}function s(i){return new Date().getTime()-i.getTime()}document.createElement("abbr"),document.createElement("time")})},17459:(Y,N,b)=>{"use strict";var x,w;const S=b(80092);x=[b(74692),b(77918)],w=function(r,A){function p(T,_){return new Promise(function(s,i){r.getJSON([config.asset_base_url,"language",T,_].join("/")+".json?"+config["cache-buster"],function(h){const f={language:T,namespace:_,data:h};Promise.resolve().then(function(){var l=[b(91749)];(function(d){d.fire("action:translator.loadClient",f),s(f.promise?Promise.resolve(f.promise):h)}).apply(null,l)}).catch(b.oe)}).fail(function(h,f,l){i(new Error(f+", "+l))})})}return S(A,p,function(){console.warn.apply(console,arguments)})}.apply(N,x),w!==void 0&&(Y.exports=w)},17833:(Y,N,b)=>{N.formatArgs=w,N.save=S,N.load=r,N.useColors=x,N.storage=A(),N.destroy=(()=>{let m=!1;return()=>{m||(m=!0,console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."))}})(),N.colors=["#0000CC","#0000FF","#0033CC","#0033FF","#0066CC","#0066FF","#0099CC","#0099FF","#00CC00","#00CC33","#00CC66","#00CC99","#00CCCC","#00CCFF","#3300CC","#3300FF","#3333CC","#3333FF","#3366CC","#3366FF","#3399CC","#3399FF","#33CC00","#33CC33","#33CC66","#33CC99","#33CCCC","#33CCFF","#6600CC","#6600FF","#6633CC","#6633FF","#66CC00","#66CC33","#9900CC","#9900FF","#9933CC","#9933FF","#99CC00","#99CC33","#CC0000","#CC0033","#CC0066","#CC0099","#CC00CC","#CC00FF","#CC3300","#CC3333","#CC3366","#CC3399","#CC33CC","#CC33FF","#CC6600","#CC6633","#CC9900","#CC9933","#CCCC00","#CCCC33","#FF0000","#FF0033","#FF0066","#FF0099","#FF00CC","#FF00FF","#FF3300","#FF3333","#FF3366","#FF3399","#FF33CC","#FF33FF","#FF6600","#FF6633","#FF9900","#FF9933","#FFCC00","#FFCC33"];function x(){if(typeof window<"u"&&window.process&&(window.process.type==="renderer"||window.process.__nwjs))return!0;if(typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/(edge|trident)\/(\d+)/))return!1;let m;return typeof document<"u"&&document.documentElement&&document.documentElement.style&&document.documentElement.style.WebkitAppearance||typeof window<"u"&&window.console&&(window.console.firebug||window.console.exception&&window.console.table)||typeof navigator<"u"&&navigator.userAgent&&(m=navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/))&&parseInt(m[1],10)>=31||typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/applewebkit\/(\d+)/)}function w(m){if(m[0]=(this.useColors?"%c":"")+this.namespace+(this.useColors?" %c":" ")+m[0]+(this.useColors?"%c ":" ")+"+"+Y.exports.humanize(this.diff),!this.useColors)return;const T="color: "+this.color;m.splice(1,0,T,"color: inherit");let _=0,s=0;m[0].replace(/%[a-zA-Z%]/g,i=>{i!=="%%"&&(_++,i==="%c"&&(s=_))}),m.splice(s,0,T)}N.log=console.debug||console.log||(()=>{});function S(m){try{m?N.storage.setItem("debug",m):N.storage.removeItem("debug")}catch{}}function r(){let m;try{m=N.storage.getItem("debug")}catch{}return!m&&typeof process<"u"&&"env"in process&&(m=process.env.DEBUG),m}function A(){try{return localStorage}catch{}}Y.exports=b(40736)(N);const{formatters:p}=Y.exports;p.j=function(m){try{return JSON.stringify(m)}catch(T){return"[UnexpectedJSONParseError]: "+T.message}}},19419:(Y,N,b)=>{"use strict";Object.defineProperty(N,"__esModule",{value:!0}),N.transports=void 0;const x=b(30528),w=b(38716),S=b(44480);N.transports={websocket:w.WS,webtransport:S.WT,polling:x.Polling}},23776:function(Y,N,b){"use strict";var x=this&&this.__createBinding||(Object.create?function(l,d,v,j){j===void 0&&(j=v),Object.defineProperty(l,j,{enumerable:!0,get:function(){return d[v]}})}:function(l,d,v,j){j===void 0&&(j=v),l[j]=d[v]}),w=this&&this.__setModuleDefault||(Object.create?function(l,d){Object.defineProperty(l,"default",{enumerable:!0,value:d})}:function(l,d){l.default=d}),S=this&&this.__importStar||function(l){if(l&&l.__esModule)return l;var d={};if(l!=null)for(var v in l)v!=="default"&&Object.prototype.hasOwnProperty.call(l,v)&&x(d,l,v);return w(d,l),d},r=this&&this.__importDefault||function(l){return l&&l.__esModule?l:{default:l}};Object.defineProperty(N,"__esModule",{value:!0}),N.Manager=void 0;const A=b(4956),p=b(56214),m=S(b(84627)),T=b(25942),_=b(57743),s=b(24454),h=r(b(17833)).default("socket.io-client:manager");class f extends s.Emitter{constructor(d,v){var j;super(),this.nsps={},this.subs=[],d&&typeof d=="object"&&(v=d,d=void 0),v=v||{},v.path=v.path||"/socket.io",this.opts=v,A.installTimerFunctions(this,v),this.reconnection(v.reconnection!==!1),this.reconnectionAttempts(v.reconnectionAttempts||1/0),this.reconnectionDelay(v.reconnectionDelay||1e3),this.reconnectionDelayMax(v.reconnectionDelayMax||5e3),this.randomizationFactor((j=v.randomizationFactor)!==null&&j!==void 0?j:.5),this.backoff=new _.Backoff({min:this.reconnectionDelay(),max:this.reconnectionDelayMax(),jitter:this.randomizationFactor()}),this.timeout(v.timeout==null?2e4:v.timeout),this._readyState="closed",this.uri=d;const D=v.parser||m;this.encoder=new D.Encoder,this.decoder=new D.Decoder,this._autoConnect=v.autoConnect!==!1,this._autoConnect&&this.open()}reconnection(d){return arguments.length?(this._reconnection=!!d,this):this._reconnection}reconnectionAttempts(d){return d===void 0?this._reconnectionAttempts:(this._reconnectionAttempts=d,this)}reconnectionDelay(d){var v;return d===void 0?this._reconnectionDelay:(this._reconnectionDelay=d,(v=this.backoff)===null||v===void 0||v.setMin(d),this)}randomizationFactor(d){var v;return d===void 0?this._randomizationFactor:(this._randomizationFactor=d,(v=this.backoff)===null||v===void 0||v.setJitter(d),this)}reconnectionDelayMax(d){var v;return d===void 0?this._reconnectionDelayMax:(this._reconnectionDelayMax=d,(v=this.backoff)===null||v===void 0||v.setMax(d),this)}timeout(d){return arguments.length?(this._timeout=d,this):this._timeout}maybeReconnectOnOpen(){!this._reconnecting&&this._reconnection&&this.backoff.attempts===0&&this.reconnect()}open(d){if(h("readyState %s",this._readyState),~this._readyState.indexOf("open"))return this;h("opening %s",this.uri),this.engine=new A.Socket(this.uri,this.opts);const v=this.engine,j=this;this._readyState="opening",this.skipReconnect=!1;const D=T.on(v,"open",function(){j.onopen(),d&&d()}),F=ee=>{h("error"),this.cleanup(),this._readyState="closed",this.emitReserved("error",ee),d?d(ee):this.maybeReconnectOnOpen()},z=T.on(v,"error",F);if(this._timeout!==!1){const ee=this._timeout;h("connect attempt will timeout after %d",ee);const re=this.setTimeoutFn(()=>{h("connect attempt timed out after %d",ee),D(),F(new Error("timeout")),v.close()},ee);this.opts.autoUnref&&re.unref(),this.subs.push(()=>{this.clearTimeoutFn(re)})}return this.subs.push(D),this.subs.push(z),this}connect(d){return this.open(d)}onopen(){h("open"),this.cleanup(),this._readyState="open",this.emitReserved("open");const d=this.engine;this.subs.push(T.on(d,"ping",this.onping.bind(this)),T.on(d,"data",this.ondata.bind(this)),T.on(d,"error",this.onerror.bind(this)),T.on(d,"close",this.onclose.bind(this)),T.on(this.decoder,"decoded",this.ondecoded.bind(this)))}onping(){this.emitReserved("ping")}ondata(d){try{this.decoder.add(d)}catch(v){this.onclose("parse error",v)}}ondecoded(d){A.nextTick(()=>{this.emitReserved("packet",d)},this.setTimeoutFn)}onerror(d){h("error",d),this.emitReserved("error",d)}socket(d,v){let j=this.nsps[d];return j?this._autoConnect&&!j.active&&j.connect():(j=new p.Socket(this,d,v),this.nsps[d]=j),j}_destroy(d){const v=Object.keys(this.nsps);for(const j of v)if(this.nsps[j].active){h("socket %s is still active, skipping close",j);return}this._close()}_packet(d){h("writing packet %j",d);const v=this.encoder.encode(d);for(let j=0;j<v.length;j++)this.engine.write(v[j],d.options)}cleanup(){h("cleanup"),this.subs.forEach(d=>d()),this.subs.length=0,this.decoder.destroy()}_close(){h("disconnect"),this.skipReconnect=!0,this._reconnecting=!1,this.onclose("forced close"),this.engine&&this.engine.close()}disconnect(){return this._close()}onclose(d,v){h("closed due to %s",d),this.cleanup(),this.backoff.reset(),this._readyState="closed",this.emitReserved("close",d,v),this._reconnection&&!this.skipReconnect&&this.reconnect()}reconnect(){if(this._reconnecting||this.skipReconnect)return this;const d=this;if(this.backoff.attempts>=this._reconnectionAttempts)h("reconnect failed"),this.backoff.reset(),this.emitReserved("reconnect_failed"),this._reconnecting=!1;else{const v=this.backoff.duration();h("will wait %dms before reconnect attempt",v),this._reconnecting=!0;const j=this.setTimeoutFn(()=>{d.skipReconnect||(h("attempting reconnect"),this.emitReserved("reconnect_attempt",d.backoff.attempts),!d.skipReconnect&&d.open(D=>{D?(h("reconnect attempt error"),d._reconnecting=!1,d.reconnect(),this.emitReserved("reconnect_error",D)):(h("reconnect success"),d.onreconnect())}))},v);this.opts.autoUnref&&j.unref(),this.subs.push(()=>{this.clearTimeoutFn(j)})}}onreconnect(){const d=this.backoff.attempts;this._reconnecting=!1,this.backoff.reset(),this.emitReserved("reconnect",d)}}N.Manager=f},24454:(Y,N,b)=>{"use strict";b.r(N),b.d(N,{Emitter:()=>x});function x(S){if(S)return w(S)}function w(S){for(var r in x.prototype)S[r]=x.prototype[r];return S}x.prototype.on=x.prototype.addEventListener=function(S,r){return this._callbacks=this._callbacks||{},(this._callbacks["$"+S]=this._callbacks["$"+S]||[]).push(r),this},x.prototype.once=function(S,r){function A(){this.off(S,A),r.apply(this,arguments)}return A.fn=r,this.on(S,A),this},x.prototype.off=x.prototype.removeListener=x.prototype.removeAllListeners=x.prototype.removeEventListener=function(S,r){if(this._callbacks=this._callbacks||{},arguments.length==0)return this._callbacks={},this;var A=this._callbacks["$"+S];if(!A)return this;if(arguments.length==1)return delete this._callbacks["$"+S],this;for(var p,m=0;m<A.length;m++)if(p=A[m],p===r||p.fn===r){A.splice(m,1);break}return A.length===0&&delete this._callbacks["$"+S],this},x.prototype.emit=function(S){this._callbacks=this._callbacks||{};for(var r=new Array(arguments.length-1),A=this._callbacks["$"+S],p=1;p<arguments.length;p++)r[p-1]=arguments[p];if(A){A=A.slice(0);for(var p=0,m=A.length;p<m;++p)A[p].apply(this,r)}return this},x.prototype.emitReserved=x.prototype.emit,x.prototype.listeners=function(S){return this._callbacks=this._callbacks||{},this._callbacks["$"+S]||[]},x.prototype.hasListeners=function(S){return!!this.listeners(S).length}},25942:(Y,N)=>{"use strict";Object.defineProperty(N,"__esModule",{value:!0}),N.on=void 0;function b(x,w,S){return x.on(w,S),function(){x.off(w,S)}}N.on=b},26235:(Y,N)=>{"use strict";Object.defineProperty(N,"__esModule",{value:!0}),N.globalThisShim=void 0,N.globalThisShim=typeof self<"u"?self:typeof window<"u"?window:Function("return this")()},26814:(Y,N,b)=>{"use strict";Y.exports.render=function(x){if(x.match(/^admin/))return;Object.keys(ajaxify.data.widgets).forEach(function(S){let r=$('#content [widget-area="'+S+'"],#content [data-widget-area="'+S+'"]').eq(0);const A=ajaxify.data.widgets[S]||[];if(r.length||!A.length)return;let p="";A.forEach(function(m){p+=m.html}),p&&(S==="footer"&&!$('#content [widget-area="footer"],#content [data-widget-area="footer"]').length?$("#content").append($('<div data-widget-area="footer"></div>')):S==="sidebar"&&!$('#content [widget-area="sidebar"],#content [data-widget-area="sidebar"]').length?$('[component="account/cover"]').length?$('[component="account/cover"]').nextAll().wrapAll($('<div class="row"><div class="col-lg-9 col-12"></div><div data-widget-area="sidebar" class="col-lg-3 col-12"></div></div></div>')):$('[component="groups/cover"]').length?$('[component="groups/cover"]').nextAll().wrapAll($('<div class="row"><div class="col-lg-9 col-12"></div><div data-widget-area="sidebar" class="col-lg-3 col-12"></div></div></div>')):$("#content > *").wrapAll($('<div class="row"><div class="col-lg-9 col-12"></div><div data-widget-area="sidebar" class="col-lg-3 col-12"></div></div></div>')):S==="header"&&!$('#content [widget-area="header"],#content [data-widget-area="header"]').length&&$("#content").prepend($('<div class="row"><div data-widget-area="header" class="col-12"></div></div>')),r=$('#content [widget-area="'+S+'"],#content [data-widget-area="'+S+'"]').eq(0),p&&r.length&&(r.html(p),r.find("img:not(.not-responsive)").addClass("img-fluid")),A.length&&r.removeClass("hidden"))}),Promise.resolve().then(function(){var S=[b(91749)];(function(r){r.fire("action:widgets.loaded",{})}).apply(null,S)}).catch(b.oe)}},28661:(Y,N)=>{"use strict";Object.defineProperty(N,"__esModule",{value:!0}),N.decode=N.encode=void 0;function b(w){let S="";for(let r in w)w.hasOwnProperty(r)&&(S.length&&(S+="&"),S+=encodeURIComponent(r)+"="+encodeURIComponent(w[r]));return S}N.encode=b;function x(w){let S={},r=w.split("&");for(let A=0,p=r.length;A<p;A++){let m=r[A].split("=");S[decodeURIComponent(m[0])]=decodeURIComponent(m[1])}return S}N.decode=x},29930:(Y,N,b)=>{"use strict";b.r(N),b.d(N,{alert:()=>A,error:()=>_,info:()=>m,remove:()=>s,success:()=>p,warning:()=>T});var x=b(52473),w=b.n(x),S=b(91749),r=b.n(S);function A(d){d.alert_id="alert_button_"+(d.alert_id?d.alert_id:new Date().getTime()),d.title=d.title&&d.title.trim()||"",d.message=d.message?d.message.trim():"",d.type=d.type||"info";const v=$("#"+d.alert_id);v.length?i(v,d):h(d)}function p(d,v){A({alert_id:utils.generateUUID(),title:"[[global:alert.success]]",message:d,type:"success",timeout:v!==void 0?v:5e3})}function m(d,v){A({alert_id:utils.generateUUID(),title:"[[global:alert.info]]",message:d,type:"info",timeout:v!==void 0?v:5e3})}function T(d,v){A({alert_id:utils.generateUUID(),title:"[[global:alert.warning]]",message:d,type:"warning",timeout:v!==void 0?v:5e3})}function _(d,v){if(d=d&&d.message||d,d==="[[error:revalidate-failure]]"){socket.disconnect(),app.reconnect();return}A({alert_id:utils.generateUUID(),title:"[[global:alert.error]]",message:d,type:"danger",timeout:v||1e4})}function s(d){$("#alert_button_"+d).remove()}function i(d,v){d.find("strong").translateHtml(v.title),d.find("p").translateHtml(v.message),d.removeClass("alert-success alert-danger alert-info alert-warning").addClass(`alert-${v.type}`),clearTimeout(parseInt(d.attr("timeoutId"),10)),v.timeout&&l(d,v),S.fire("action:alert.update",{alert:d,params:v}),d.off("click").removeClass("pointer"),typeof v.clickfn=="function"&&d.addClass("pointer").on("click",function(j){$(j.target).is(".btn-close")||(v.clickfn(),f(d))})}function h(d){app.parseAndTranslate("partials/toast",d,function(v){let j=$("#"+d.alert_id);if(j.length)return i(j,d);j=v,j.hide().fadeIn(200).prependTo(x.get("toaster/tray")),j.on("close.bs.alert",function(){typeof d.closefn=="function"&&d.closefn();const D=j.attr("timeoutId");D&&(clearTimeout(D),j.removeAttr("timeoutId"))}),parseInt(d.timeout,10)&&l(j,d),typeof d.clickfn=="function"&&j.addClass("pointer").on("click",function(D){$(D.target).is(".btn-close")||(d.clickfn(j,d),f(j))}),S.fire("action:alert.new",{alert:j,params:d})})}function f(d){d.alert("close")}function l(d,v){const j=parseInt(v.timeout,10),D=setTimeout(function(){d.removeAttr("timeoutId"),f(d),typeof v.timeoutfn=="function"&&v.timeoutfn(d,v)},j);d.attr("timeoutId",D);const F=d.find(".alert-progress");F.css("transition-property","none"),F.removeClass("animate"),setTimeout(function(){F.css("transition-property",""),F.css("transition","width "+(j+450)+"ms linear"),F.addClass("animate"),S.fire("action:alert.animate",{alert:d,alertProgress:F,params:v})},50),d.on("mouseenter",function(){F.css("transition-duration",0)})}},30528:function(Y,N,b){"use strict";var x=this&&this.__importDefault||function(v){return v&&v.__esModule?v:{default:v}};Object.defineProperty(N,"__esModule",{value:!0}),N.Request=N.Polling=void 0;const w=b(44689),S=x(b(17833)),r=b(80732),A=b(46376),p=b(3519),m=b(24454),T=b(85374),_=b(26235),s=(0,S.default)("engine.io-client:polling");function i(){}const h=function(){return new p.XHR({xdomain:!1}).responseType!=null}();class f extends w.Transport{constructor(j){if(super(j),this.polling=!1,typeof location<"u"){const F=location.protocol==="https:";let z=location.port;z||(z=F?"443":"80"),this.xd=typeof location<"u"&&j.hostname!==location.hostname||z!==j.port}const D=j&&j.forceBase64;this.supportsBinary=h&&!D,this.opts.withCredentials&&(this.cookieJar=(0,p.createCookieJar)())}get name(){return"polling"}doOpen(){this.poll()}pause(j){this.readyState="pausing";const D=()=>{s("paused"),this.readyState="paused",j()};if(this.polling||!this.writable){let F=0;this.polling&&(s("we are currently polling - waiting to pause"),F++,this.once("pollComplete",function(){s("pre-pause polling complete"),--F||D()})),this.writable||(s("we are currently writing - waiting to pause"),F++,this.once("drain",function(){s("pre-pause writing complete"),--F||D()}))}else D()}poll(){s("polling"),this.polling=!0,this.doPoll(),this.emitReserved("poll")}onData(j){s("polling got data %s",j);const D=F=>{if(this.readyState==="opening"&&F.type==="open"&&this.onOpen(),F.type==="close")return this.onClose({description:"transport closed by the server"}),!1;this.onPacket(F)};(0,A.decodePayload)(j,this.socket.binaryType).forEach(D),this.readyState!=="closed"&&(this.polling=!1,this.emitReserved("pollComplete"),this.readyState==="open"?this.poll():s('ignoring poll - transport state "%s"',this.readyState))}doClose(){const j=()=>{s("writing close packet"),this.write([{type:"close"}])};this.readyState==="open"?(s("transport open - closing"),j()):(s("transport not open - deferring close"),this.once("open",j))}write(j){this.writable=!1,(0,A.encodePayload)(j,D=>{this.doWrite(D,()=>{this.writable=!0,this.emitReserved("drain")})})}uri(){const j=this.opts.secure?"https":"http",D=this.query||{};return this.opts.timestampRequests!==!1&&(D[this.opts.timestampParam]=(0,r.yeast)()),!this.supportsBinary&&!D.sid&&(D.b64=1),this.createUri(j,D)}request(j={}){return Object.assign(j,{xd:this.xd,cookieJar:this.cookieJar},this.opts),new l(this.uri(),j)}doWrite(j,D){const F=this.request({method:"POST",data:j});F.on("success",D),F.on("error",(z,ee)=>{this.onError("xhr post error",z,ee)})}doPoll(){s("xhr poll");const j=this.request();j.on("data",this.onData.bind(this)),j.on("error",(D,F)=>{this.onError("xhr poll error",D,F)}),this.pollXhr=j}}N.Polling=f;class l extends m.Emitter{constructor(j,D){super(),(0,T.installTimerFunctions)(this,D),this.opts=D,this.method=D.method||"GET",this.uri=j,this.data=D.data!==void 0?D.data:null,this.create()}create(){var j;const D=(0,T.pick)(this.opts,"agent","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","autoUnref");D.xdomain=!!this.opts.xd;const F=this.xhr=new p.XHR(D);try{s("xhr open %s: %s",this.method,this.uri),F.open(this.method,this.uri,!0);try{if(this.opts.extraHeaders){F.setDisableHeaderCheck&&F.setDisableHeaderCheck(!0);for(let z in this.opts.extraHeaders)this.opts.extraHeaders.hasOwnProperty(z)&&F.setRequestHeader(z,this.opts.extraHeaders[z])}}catch{}if(this.method==="POST")try{F.setRequestHeader("Content-type","text/plain;charset=UTF-8")}catch{}try{F.setRequestHeader("Accept","*/*")}catch{}(j=this.opts.cookieJar)===null||j===void 0||j.addCookies(F),"withCredentials"in F&&(F.withCredentials=this.opts.withCredentials),this.opts.requestTimeout&&(F.timeout=this.opts.requestTimeout),F.onreadystatechange=()=>{var z;F.readyState===3&&((z=this.opts.cookieJar)===null||z===void 0||z.parseCookies(F)),F.readyState===4&&(F.status===200||F.status===1223?this.onLoad():this.setTimeoutFn(()=>{this.onError(typeof F.status=="number"?F.status:0)},0))},s("xhr data %s",this.data),F.send(this.data)}catch(z){this.setTimeoutFn(()=>{this.onError(z)},0);return}typeof document<"u"&&(this.index=l.requestsCount++,l.requests[this.index]=this)}onError(j){this.emitReserved("error",j,this.xhr),this.cleanup(!0)}cleanup(j){if(!(typeof this.xhr>"u"||this.xhr===null)){if(this.xhr.onreadystatechange=i,j)try{this.xhr.abort()}catch{}typeof document<"u"&&delete l.requests[this.index],this.xhr=null}}onLoad(){const j=this.xhr.responseText;j!==null&&(this.emitReserved("data",j),this.emitReserved("success"),this.cleanup())}abort(){this.cleanup()}}if(N.Request=l,l.requestsCount=0,l.requests={},typeof document<"u"){if(typeof attachEvent=="function")attachEvent("onunload",d);else if(typeof addEventListener=="function"){const v="onpagehide"in _.globalThisShim?"pagehide":"unload";addEventListener(v,d,!1)}}function d(){for(let v in l.requests)l.requests.hasOwnProperty(v)&&l.requests[v].abort()}},32662:(Y,N,b)=>{"use strict";Object.defineProperty(N,"__esModule",{value:!0}),N.decodePacket=void 0;const x=b(62046),w=b(42745),S=typeof ArrayBuffer=="function",r=(m,T)=>{if(typeof m!="string")return{type:"message",data:p(m,T)};const _=m.charAt(0);return _==="b"?{type:"message",data:A(m.substring(1),T)}:x.PACKET_TYPES_REVERSE[_]?m.length>1?{type:x.PACKET_TYPES_REVERSE[_],data:m.substring(1)}:{type:x.PACKET_TYPES_REVERSE[_]}:x.ERROR_PACKET};N.decodePacket=r;const A=(m,T)=>{if(S){const _=(0,w.decode)(m);return p(_,T)}else return{base64:!0,data:m}},p=(m,T)=>{switch(T){case"blob":return m instanceof Blob?m:new Blob([m]);case"arraybuffer":default:return m instanceof ArrayBuffer?m:m.buffer}}},34110:(Y,N)=>{"use strict";Object.defineProperty(N,"__esModule",{value:!0}),N.hasCORS=void 0;let b=!1;try{b=typeof XMLHttpRequest<"u"&&"withCredentials"in new XMLHttpRequest}catch{}N.hasCORS=b},38007:function(Y,N,b){"use strict";var x=this&&this.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(N,"__esModule",{value:!0}),N.default=N.connect=N.io=N.Socket=N.Manager=N.protocol=void 0;const w=b(76894),S=b(23776);Object.defineProperty(N,"Manager",{enumerable:!0,get:function(){return S.Manager}});const r=b(56214);Object.defineProperty(N,"Socket",{enumerable:!0,get:function(){return r.Socket}});const p=x(b(17833)).default("socket.io-client"),m={};function T(s,i){typeof s=="object"&&(i=s,s=void 0),i=i||{};const h=w.url(s,i.path||"/socket.io"),f=h.source,l=h.id,d=h.path,v=m[l]&&d in m[l].nsps,j=i.forceNew||i["force new connection"]||i.multiplex===!1||v;let D;return j?(p("ignoring socket cache for %s",f),D=new S.Manager(f,i)):(m[l]||(p("new io instance for %s",f),m[l]=new S.Manager(f,i)),D=m[l]),h.query&&!i.query&&(i.query=h.queryKey),D.socket(h.path,i)}N.io=T,N.connect=T,N.default=T,Object.assign(T,{Manager:S.Manager,Socket:r.Socket,io:T,connect:T});var _=b(84627);Object.defineProperty(N,"protocol",{enumerable:!0,get:function(){return _.protocol}}),Y.exports=T},38716:function(Y,N,b){"use strict";var x=this&&this.__importDefault||function(i){return i&&i.__esModule?i:{default:i}};Object.defineProperty(N,"__esModule",{value:!0}),N.WS=void 0;const w=b(44689),S=b(80732),r=b(85374),A=b(94087),p=x(b(17833)),m=b(46376),T=(0,p.default)("engine.io-client:websocket"),_=typeof navigator<"u"&&typeof navigator.product=="string"&&navigator.product.toLowerCase()==="reactnative";class s extends w.Transport{constructor(h){super(h),this.supportsBinary=!h.forceBase64}get name(){return"websocket"}doOpen(){if(!this.check())return;const h=this.uri(),f=this.opts.protocols,l=_?{}:(0,r.pick)(this.opts,"agent","perMessageDeflate","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","localAddress","protocolVersion","origin","maxPayload","family","checkServerIdentity");this.opts.extraHeaders&&(l.headers=this.opts.extraHeaders);try{this.ws=A.usingBrowserWebSocket&&!_?f?new A.WebSocket(h,f):new A.WebSocket(h):new A.WebSocket(h,f,l)}catch(d){return this.emitReserved("error",d)}this.ws.binaryType=this.socket.binaryType,this.addEventListeners()}addEventListeners(){this.ws.onopen=()=>{this.opts.autoUnref&&this.ws._socket.unref(),this.onOpen()},this.ws.onclose=h=>this.onClose({description:"websocket connection closed",context:h}),this.ws.onmessage=h=>this.onData(h.data),this.ws.onerror=h=>this.onError("websocket error",h)}write(h){this.writable=!1;for(let f=0;f<h.length;f++){const l=h[f],d=f===h.length-1;(0,m.encodePacket)(l,this.supportsBinary,v=>{const j={};A.usingBrowserWebSocket||(l.options&&(j.compress=l.options.compress),this.opts.perMessageDeflate&&(typeof v=="string"?Buffer.byteLength(v):v.length)<this.opts.perMessageDeflate.threshold&&(j.compress=!1));try{A.usingBrowserWebSocket?this.ws.send(v):this.ws.send(v,j)}catch{T("websocket closed before onclose event")}d&&(0,A.nextTick)(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){typeof this.ws<"u"&&(this.ws.close(),this.ws=null)}uri(){const h=this.opts.secure?"wss":"ws",f=this.query||{};return this.opts.timestampRequests&&(f[this.opts.timestampParam]=(0,S.yeast)()),this.supportsBinary||(f.b64=1),this.createUri(h,f)}check(){return!!A.WebSocket}}N.WS=s},40027:function(Y,N,b){var x,w,S;/*! @preserve
* bootbox.js
* version: 6.0.0
